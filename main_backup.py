...
#from print import Print_auto
#from print import file_check
#from auto_print import auto_print_module
...
if res == "yes":
    res = messagebox.showerror("print_start","印刷を開始します")
    print("印刷を開始します")
    from auto_print import auto_print_module, file_check
    auto_print_module("C:/Users/obi21703/PycharmProjects/差し込み印刷/print_list")
